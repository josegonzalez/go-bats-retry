NAME = bats-retry
EMAIL = bats-retry@josediazgonzalez.com
MAINTAINER = josegonzalez
MAINTAINER_NAME = Jose Diaz-Gonzalez
REPOSITORY = go-bats-retry
...
Utility that writes out the a script containing failed and
skipped bats tests from a set of junit xml result files.
endef
